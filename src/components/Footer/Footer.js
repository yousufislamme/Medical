               ...
               <div className='container mx-auto px-20 '>
                  <div className="grid grid-cols-2">
                     <div className="bg-white mx-14 px-10 py-20 rounded-tr-[50px] rounded-bl-[50px] mt-[-150px] shadow-lg">
                        ...
                        <div>
                           <p className='py-5 text-lg'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Error doloribus quod delectus. Beatae quos asperiores dicta voluptatum libero voluptates fuga. Eveniet libero culpa mollitia tempora cum voluptate dolor numquam! Sequi.</p>
                        </div>
                        <div className='flex flex-col'>
                           ...
                           <div className='flex'>
                              ...
                              <div className='mt-3 ml-5'>
                                 ...
                                 <a href='tel: +123 45667 890'>+ 123 45667 890</a>
                              </div>
                           </div>
                           <div className='flex'>
                              <div className='flex justify-center items-center  w-12 h-12 my-3 bg-[#0014FF] rounded-full'>
                     ...
                     <div className="">
                        <div>
                           <p className='text-lg mb-10'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, voluptates. Odio commodi accusamus asperiores corporis, eligendi quisquam expedita aliquam et blanditiis non aliquid? Voluptates, aliquid!</p>
                        ...
                        <div className='flex pt-10'>
                           <div className='mr-10'>
                              ...
                              <ul>
                                 <li className='leading-[30px]'><a href="#">Mkae An Appointment</a></li>
                                 <li className='leading-[30px]'><a href="#">Our Service</a></li>
                                 <li className='leading-[30px]'><a href="#">Doctors</a></li>
                                 <li className='leading-[30px]'><a href="#">About Dentino</a></li>
                                 <li className='leading-[30px]'><a href="#">Our Contacts</a></li>
                              </ul>
                           </div>
                           <div className='mr-10'>
