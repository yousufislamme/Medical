         ...
         <div className="flex flex-row">
            ...
            <div className="flex-1 xl:mt-[200px]">
               <motion.h2
                  ...
                  className='text-[32px] sm:text-[44px] mb-5 lg:mb-0 lg:text-[54px] fontStyle text-slate-700'>Services</motion.h2>
               <motion.p
                  initial={{ y: 20, opacity: 0 }}
                  whileInView={{ y: 1, opacity: 1 }}
                  ...
                  className='text-slate-700 text-lg lg:text-lg'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Beatae, ratione.</motion.p>
