   ...
   return (
      <div className='container mx-auto px-5 lg:px-20 py-20'>
         <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-3">
            <div>
               <h2 className='fontStyle text-[32px] lg:text-[45px]'>Our Clinic</h2>
               <p className='py-5 text-lg'>Lorem ipsum dolor sit amet consectetur adipisicing elit. In magni minus possimus harum est commodi a nesciunt facere tempore excepturi?</p>
               <div className=''>
